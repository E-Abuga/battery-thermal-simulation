...
The simulation solves the 2D heat conduction equation with internal heat 
generation (representing battery discharge) and convective cooling on all four 
boundaries (Newton's law of cooling). The numerical grid consists of 81×41 nodes 
across a 6cm × 2cm cross-section, with the time integration running over 50 
seconds using a stability-constrained time step.
